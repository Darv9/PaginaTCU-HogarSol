document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('updateForm').addEventListener('submit', function(event){
        ...
        if(validateForm()){
            updateUserMain(); // Función para actualizar el usuario mediante AJAX
        }
    });
});
...
function populateForm(){
    ...
    fetch(`../../src/routes/getUserByIdRoutes.php?action=getUserById&userId=${userId}`)
...
function updateUserMain(){
    ...
    fetch('../../src/routes/editUserRoutes.php', {
        method: 'POST',
        headers: {
