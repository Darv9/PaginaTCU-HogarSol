...
document.getElementById('logoutButton').addEventListener('click', function(event) {
    ...
    fetch('http://localhost/hogarsolweb/PaginaTCU-HogarSol/src/routes/logout.php', {
    ...
    .then(response => {
        if (response.ok) {
            ...
            window.location.href = 'http://localhost/hogarsolweb/PaginaTCU-HogarSol/public/login.php'; // Cambia 'login.php' por la página a la que desees redirigir
        } else {
